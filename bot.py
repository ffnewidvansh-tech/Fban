...
# ============================================================
# TERA EMOJI MAPPING - SIRF YAHI USE HOGA
# ============================================================
EMOJI_MAPPING = {
...
# ============================================================
# GET RANDOM EMOJI ID FROM TERA MAPPING
# ============================================================
def get_random_emoji_id():
    """Tere EMOJI_MAPPING se random emoji ID return karega"""
    all_ids = []
...
def get_emoji_id_for_char(ch):
    if ch in EMOJI_MAPPING:
        return random.choice(EMOJI_MAPPING[ch])
    if ch in FLAG_MAPPING:
        return FLAG_MAPPING[ch]
    return get_random_emoji_id()
...
# ============================================================
# EMOJI HELPERS - SIRF TERA MAPPING
# ============================================================
...
def _build_pe_entities(text: str):
    ...
    while i < len(text):
        ...
        # Sirf tera EMOJI_MAPPING use - verified wala system hatao
        if ch in EMOJI_MAPPING:
...
# ============================================================
# MAKE COLORED BUTTONS - NO EMOJIS
# ============================================================
