...
# ============================================================
# GET USER MENU - ALL GREEN BUTTONS
# ============================================================
...
def process_ban_check(message):
    try:
        ...
        msg = _send_pe_return(message.chat.id, f"⏳ ᴄʜᴇᴄᴋɪɴɢ...")
...
✅ 🆔 ᴀᴄᴄᴏᴜɴᴛ: {data.get('account_id', 'N/A')}
✅ 👤 ɴɪᴄᴋɴᴀᴍᴇ: {data.get('nickname', 'Unknown')}
✅ 🌍 ʀᴇɢɪᴏɴ: {data.get('region', 'N/A')}
✅ 📊 ʟᴇᴠᴇʟ: {data.get('level', 'N/A')}

✅ ═══════════════════════ ✅

✅ 📌 sᴛᴀᴛᴜs: {'🚫 ʙᴀɴɴᴇᴅ' if is_banned else '✅ ᴀᴄᴛɪᴠᴇ'}

"""
            if is_banned:
                text += f"""
✅ ⏰ sᴛᴀʀᴛ: {ban_info.get('ban_start_time', 'N/A')}
✅ ⏳ ᴇɴᴅ: {ban_info.get('ban_end_time', 'N/A')}
✅ 📅 ʀᴇᴍᴀɪɴɪɴɢ: {ban_info.get('ban_expire_duration', 'N/A')}
"""
...
"""
            ...
            _send_pe(message.chat.id, f"❌ ғᴀɪʟᴇᴅ ᴛᴏ ғᴇᴛᴄʜ!")
    except Exception as e:
...
def process_guest_to_token(message):
    try:
        ...
        msg = _send_pe_return(message.chat.id, f"⏳ ɢᴇɴᴇʀᴀᴛɪɴɢ ᴛᴏᴋᴇɴ...")
...
def process_eat_to_token(message):
    try:
        ...
        msg = _send_pe_return(message.chat.id, f"⏳ ᴄᴏɴᴠᴇʀᴛɪɴɢ...")
